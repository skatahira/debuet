...
class UneditableText: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tv = UITextView(frame: CGRect(x: 0, y: 0, width: self.frame.width-30, height: self.frame.height-50))
        self.addSubview(tv)
